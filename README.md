<h1 align="center">
  Pettok 虚拟宠物伴侣 (基于 Douyin-Vue 深度定制)
</h1>

<p align="center">
  <b>🐱 一个在短视频流中为你提供情感陪伴、数据洞察和智能对话的虚拟宠物。</b>
</p>

## ✨ Pettok 核心功能描述

Pettok 是一个创新性的前端黑客松项目，深度嵌入在短视频信息流中。它通过一只可爱的像素风虚拟小猫，将用户的观看行为转化为有温度的陪伴：

- **📊 智能数据洞察**：分析你的“今日饮食”（视频类型占比、观看时长），并提供直观的营养和健康状态雷达图。
- **💌 情感陪伴信件**：根据你的观看习惯，Pettok 会自动生成温暖的“今日来信”（如：至主人、食评、自语）。
- **💬 大模型 AI 智能对话**：**本项目的宠物对话系统深度接入了业界领先的大语言模型（LLM）API。** 通过大模型的语义理解能力，Pettok 不仅能听懂你的日常倾诉，还能根据你在平台上的观看习惯给出具有“猫咪人设”的情感回复，提供极具温度的交互体验！
- **🌍 宠物社交圈**：包含状态分享、在线提示及高级玻璃拟态 UI 的点赞交互模块。
- **🚀 极致性能**：放弃重量级的 WebGL，采用纯 CSS 的高性能帧动画（Sprite Animation）驱动，并在复杂的视频滑动组件中完美解决事件拦截冲突。

---

<h2 align="center">以下为原项目 Douyin-Vue 介绍</h2>
